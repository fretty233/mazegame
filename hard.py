...
if __name__=='__main__':
    ...
    h1=agent(myMaze,4,5,color=COLOR.red)
    h2=agent(myMaze,4,4,color=COLOR.red)
    h3=agent(myMaze,4,3,color=COLOR.red)
    h4=agent(myMaze,4,2,color=COLOR.red)
    h5=agent(myMaze,4,1,color=COLOR.red)
    ...
    a=agent(myMaze,6,1,filled=True,footprints=True)
    # myMaze.tracePath({a:path},delay=200,kill=True)

    myMaze.enableArrowKey(a)
